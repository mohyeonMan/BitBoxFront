...
const Calendar = () => {
    ...
    const findTime = (e) => {
        ...
        axios.post(`https://bitbox-project.herokuapp.com/book/timeList?movie_date=${dsd}&movie_title=${movieName}&movie_city=${cityName}&movie_cinema=${cinemaName}`)
    ...
    const findCinema = (e) => {
        ...
        axios.post(`https://bitbox-project.herokuapp.com/book/cinemaList?movie_date=${dsd}&movie_title=${movieName}&movie_city=${cityName}`)
    ...
    const findCity = (e) => {
        ...
        axios.post(`https://bitbox-project.herokuapp.com/book/cityList?movie_date=${dsd}&movie_title=${movieName}`)
    ...
    useEffect(()=>{
        setHidden(false)
        axios.post(`https://bitbox-project.herokuapp.com/book/movieList?movie_date=${dsd}`)
            .then(res=>{
