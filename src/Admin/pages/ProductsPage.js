...
useEffect(() => {
    axios.get('https://bitbox-project.herokuapp.com/movielist/admin_movie_list')
...
const movieDelete = (movieTitle)=> {
  ...
  axios.delete(`https://bitbox-project.herokuapp.com/movielist/admin_movie_delete?movie_title=${movieTitle}`)
        .then(()=>{alert('삭제 완료')})
