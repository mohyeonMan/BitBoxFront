...
const Movielist_tab02 = () => {
    ...
    const movie_add_list = () => {
        axios.get('http://localhost:8080/movielist/getMovieList_tobereleased')
    ...
    const movie_already_release_filter = () => {
        axios.get('http://localhost:8080/movielist/getMovieList_already_on_tobereleased')
            .then(res => {setMovie_count(res.data.length)
                                ...
                                <ol className='Movielist_seq' >
                                    <li>
                                        ...
                                        {/* <div className='Movielist_Btnlist'>
                                            ...
                                            {list.movie_class === "2" ? <a href="#"><input type='button' className='Movie_Btn_reserve_yet' value="개봉예정"></input></a>:false}
                                            {list.movie_class !== "2" ? <a href="#"><input type='button' className='Movie_Btn_reserve' value="예매"></input></a>:false}
                                    </li>
