...
const Movielist_tab04 = () => {
    ...
    useEffect(() => {
        axios.get(already_released ? 'http://localhost:8080/movielist/getMovieList_already_on_filmsociety' : 'http://localhost:8080/movielist/getMovieList_filmsociety')
    ...
    const onSearch = (e) => {
        e.preventDefault();
        axios
            .get('http://localhost:8080/movielist/Movie_search_filmsociety', {
                    params : {
