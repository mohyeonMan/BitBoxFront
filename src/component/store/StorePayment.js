...
const StorePayment = () => {
        ...
        IMP.request_pay(
            ...
            res => {
                ...
                if (res.success) {
                    ...
                    axios.post('https://bitbox-project.herokuapp.com/store/insertPay', null, {params: {
    ...
    useEffect(() => {
        axios.get(`https://bitbox-project.herokuapp.com/store/getOne?userName=${sessionStorage.getItem("userName")}&store_seq=${store_seq}`)
