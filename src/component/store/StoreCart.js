...
const StoreCart = () => {
    ...
    useEffect(() => {
        axios.get(`https://bitbox-project.herokuapp.com/store/getCartList?userName=${sessionStorage.getItem("userName")}`)
    ...
    axios.get(`https://bitbox-project.herokuapp.com/store/getCartList?userName=${sessionStorage.getItem("userName")}`)
         ...
         axios.get(`https://bitbox-project.herokuapp.com/store/getCartListCount?userName=${sessionStorage.getItem("userName")}`)
    ...
    const onDelete = (targetSeq) => {
        ...
        setList(newList);
        axios.get(`https://bitbox-project.herokuapp.com/store/deleteCart?cart_seq=${targetSeq}`)
    ...
    const onBuy = () => {
        ...
        for (let i = 0; i < list.length; i++) {
            ...
            axios.post('https://bitbox-project.herokuapp.com/store/updateCart', null, {params: {
